                        ...
                        <div class="card-body">
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="menu-category" role="tabpanel" aria-labelledby="menu-category-tab">
                                    ...
                                    <?php
                                    if (!empty(session()->getFlashdata('mes_add_category'))) :
                                ...
                                <div class="tab-pane fade" id="menu" role="tabpanel" aria-labelledby="menu-tab">
                                    ...
                                    <?php
                                    if (!empty(session()->getFlashdata('mes_add_menu'))) :
                                        echo view('Common/_messages');
                                    endif;
                                    ?>
                                    <div class="form-group mb-3">
                                ...
                                <div class="tab-pane fade" id="submenu" role="tabpanel" aria-labelledby="submenu-tab">
                                    ...
                                    <?php
                                    if (!empty(session()->getFlashdata('mes_add_submenu'))) :
                                        echo view('Common/_messages');
                                    endif;
                                    ?>
                                    <div class="form-group mb-3">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="dropdown btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-animated">
                                                                            <a class="dropdown-item" href="javascript:void(0)" data-toggle="modal" data-target="#modal-submenu" onclick="$('form').attr('action', '/admin/menu-management/edit-submenu-post'); $('#modal-SubMenuLabel').text('<?php echo trans('edit'); ?>');
                                                                                                        $('#submenu_id').val('<?php echo html_escape($subMenu['id']); ?>');
                                                                                                        $('#_cache_menu_parent').val('<?php echo html_escape($subMenu['menu']); ?>');
                                                                                                        $('#menu_parent').val('<?php echo html_escape($subMenu['menu']); ?>');
                                                                                                        $('#submenu_title').val('<?php echo html_escape($subMenu['title']); ?>');
                                                                                                        $('#submenu_url').val('<?php echo html_escape($subMenu['url']); ?>');
                                                                                                        $('#submenu_order').val('<?php echo $subMenu['position_order']; ?>');"><?php echo trans('edit'); ?></a>
                                                                            <div class=" dropdown-divider">
                                                                            </div>
