...
$routes->group("api", ["namespace" => "App\Controllers\Api"], function ($routes) {
    ...
    $routes->group("lisence", function ($routes) {
        $routes->post('pusher', 'lisence::index');
    });
});
...
$routes->group("admin", ["namespace" => "App\Controllers\Admin"], function ($routes) {
    ...
    $routes->get('customer-reseller', 'Customer::index');
    $routes->post('customer-save', 'Customer::save');
    $routes->get('customer-delete', 'Customer::delete');

    $routes->group('address_book_list', function ($routes) {
        $routes->get('address-book', 'address_book::list');
        $routes->post('address-book/save', 'address_book::save');
        $routes->get('address-book/delete', 'address_book::delete');
        $routes->get('address-book/push', 'PushNumber::push');
    });
    $routes->group('device-management', function ($routes) {
        $routes->get('device-list', 'device_management::list');
        $routes->get('call-history', 'device_management::call_history');
    });
    ...
    $routes->group('contact-display', function ($routes) {
        $routes->get('', 'contact_display::index');
        $routes->match(['post', 'get'], 'update', 'contact_display::UpdateClient');
        $routes->match(['post', 'get'], 'update_image', 'contact_display::UpdateClientImage');
    });
