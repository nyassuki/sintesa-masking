...
class UsersModel extends Model {
    ...
    public function input_values() {
        $data = array(
            'username' => strtolower(remove_special_characters(($this->request->getVar('username', FILTER_SANITIZE_FULL_SPECIAL_CHARS))) ?? ''),
    ...
    public function add_user() {
        ...
        $logged_user=json_decode(json_encode($logged_user),1);
        ...
        $data['client_id'] = $this->request->getVar('company', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
